...
const LogoRetool = () => (
  <svg viewBox="0 0 180 56" fill="currentColor" style={{ width: '100%', height: '100%' }}>
...
const LogoVercel = () => (
  <svg viewBox="0 0 180 54" fill="currentColor" style={{ width: '100%', height: '100%' }}>
...
export default function Home() {
  ...
  return (
    <main id="main-content">
      ...
      {/* ── Logo strip ─────────────────────────────────────── */}
      <section style={{ padding: 'var(--space-16) 0 var(--space-12)', borderTop: '1px solid var(--color-border)' }}>
        <p style={{ textAlign: 'center', fontSize: 'var(--text-xs)', color: 'var(--color-muted)', marginBottom: 'var(--space-6)', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
        ...
        <div style={{ position: 'relative', height: '56px' }}>
          ...
          >
            {LOGOS.map(({ id, Logo }) => (
              <div key={id} style={{ width: 120, height: 40, color: 'var(--color-muted)', flexShrink: 0 }}>
                <Logo />
              </div>
            ))}
          </InfiniteSlider>
          <ProgressiveBlur className="pointer-events-none absolute top-0 left-0 h-full w-36" direction="left" blurIntensity={1} />
          <ProgressiveBlur className="pointer-events-none absolute top-0 right-0 h-full w-36" direction="right" blurIntensity={1} />
        </div>
      </section>

      {/* Stats row */}
      <section style={{ borderTop: '1px solid var(--color-border)', borderBottom: '1px solid var(--color-border)', position: 'relative' }}>
        <div className="container">
          <div style={{
            ...
            {STATS.map(({ value, label }, i) => (
              <ScrollReveal key={value} delay={i * 0.07}>
                <div style={{
      ...
      {/* Studio intro */}
      <section style={{ padding: 'var(--space-32) 0', position: 'relative' }}>
        <div className="container">
          <ScrollReveal>
            <span className="label" style={{ display: 'block', marginBottom: 'var(--space-8)' }}>
              Studio
            </span>
            <h2 style={{
              ...
              A branding studio that refuses to make forgettable work.
            </h2>
          </ScrollReveal>
          ...
          <div style={{
            ...
            <ScrollReveal>
              <div style={{ borderTop: '1px solid var(--color-border)', paddingTop: 'var(--space-6)' }}>
                <div style={{
                  fontSize: 'clamp(3rem, 5vw, var(--text-5xl))',
                  fontWeight: 600,
                  letterSpacing: '-0.04em',
                  lineHeight: 1,
                ...
                <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-muted)', letterSpacing: '0.04em' }}>
                  Est. Stockholm
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.1}>
              <div>
                <p style={{
                  ...
                  Lumense is an independent creative studio based in Stockholm. We partner with ambitious brands to craft identities, campaigns, and motion work that stands apart.
                </p>
                <p style={{
                  ...
                  Our process is direct. We ask difficult questions early, so the work that emerges is inevitable — not compromised.
                </p>
                <div style={{ display: 'flex', gap: 'var(--space-4)', flexWrap: 'wrap' }}>
                  <HoverLink to="/services" variant="outline">What we do</HoverLink>
                  <HoverLink to="/work" variant="outline">View work →</HoverLink>
                </div>
              </div>
            </ScrollReveal>
          </div>
      ...
      {/* Services preview — editorial rows */}
      <section style={{
        ...
        <div className="container">
          ...
          {[
            { num: '01', title: 'Branding', desc: 'Identities built to endure.' },
            { num: '02', title: 'Motion Design', desc: 'Ideas that move with intention.' },
            { num: '03', title: 'Graphic Design', desc: 'Print and digital, executed with precision.' },
          ].map(({ num, title, desc }, i) => (
            <ScrollReveal key={title} delay={i * 0.06}>
              <Link to="/services" style={{ display: 'block', color: 'inherit', textDecoration: 'none' }}>
                <motion.div
                  whileHover="hover"
                  style={{
                    display: 'grid',
      ...
      <section style={{
        ...
        <div style={{
          position: 'absolute',
          inset: 0,
          background: 'radial-gradient(ellipse at 50% 100%, rgba(33,118,174,0.12) 0%, transparent 65%)',
          pointerEvents: 'none',
        }} />
